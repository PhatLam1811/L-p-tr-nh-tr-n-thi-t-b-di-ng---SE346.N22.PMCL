  ...
  return (
    <View style={styles.mainScreen}>
      <View style={styles.mainScreen__header}>
        ...
        <Switch
          value={appContext.appTheme === DarkTheme}
          onValueChange={appContext.changeAppTheme}
        />
      </View>
      ...
      <View style={styles.mainScreen__toolbar}>
        ...
        {/* <FAB
                    ...
                    icon={props=> <OctIcon name="plus" {...styles.mainScreen__icon}/>}
                    onPress={() => CreateNoteHandler()}
                /> */}

        <TouchableOpacity
          style={styles.mainScreen__newNoteFAB}
          onPress={() => CreateNoteHandler()}>
          <OctIcon name="plus" {...styles.mainScreen__icon_plus} />
        </TouchableOpacity>
      </View>
    </View>
  );

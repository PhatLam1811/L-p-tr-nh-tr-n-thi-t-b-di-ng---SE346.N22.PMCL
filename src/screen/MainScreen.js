...
const MainScreen = props => {
  ...
  const [imageSource, setImageSource] = useState(
    'file:///data/user/0/com.myproj/cache/rn_image_picker_lib_temp_951e0e08-04d6-4241-9180-00131d846b96.png',
  );
  ...
  const onShare = async () => {
    try {
      ...
      const result = await Share.share({
        message:
          JSON.stringify({noteTile:'title',subTitle:'subtitle',content:'test sharing object'}),
      });
